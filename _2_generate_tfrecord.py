...
csv_input = path_to_csv + "train_labels.csv"
csv_input_2 = path_to_csv + "test_labels.csv"
image_dir = path_to_images + 'train'
image_dir_2 = path_to_images + 'test'
output_path = output_path_record + "train.record"
output_path_2 = output_path_record + "test.record"
